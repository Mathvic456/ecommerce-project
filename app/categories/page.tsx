    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
          <h1 className="text-3xl lg:text-5xl font-serif text-center mb-4">Shop All Products</h1>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={`block w-full text-left py-2 ${!selectedCategory ? "font-medium" : "text-muted-foreground"}`}
                  >
                    All Products
                  </button>
                  {categories.map((category) => (
                    <button
                      ...
                      className={`block w-full text-left py-2 ${selectedCategory === category.id ? "font-medium" : "text-muted-foreground"}`}
                    >
                      {category.name}
                    </button>
                  ))}
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground mb-8">
              {selectedCategory ? "Try selecting a different category" : "Check back soon for new products"}
            </p>
            {selectedCategory && (
              <button
                onClick={() => setSelectedCategory(null)}
